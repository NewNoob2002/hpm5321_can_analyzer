...
| MCAN0 controlled transmit, reset-disarmed image | ABI-v4 ELF `bbbef9d7...`: reset-disarmed PASS; explicit one-shot ARM target TX 100/100 and cleanup readback PASS | PARTIAL | External capture reconciliation is pending; T-CAN-012 remains partial due reset-to-first-instruction/external zero-traffic gaps, and formal product T-CAN-013 remains NOT_TESTED |
