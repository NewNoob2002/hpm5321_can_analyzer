...
| Physical cable hotplug | NOT_TESTED | P3A/T-USB-007 owns 100 physical cable cycles; `scripts/phase3/collect_usb_hotplug.py` now counts real disappearance/re-enumeration and requires a recovery transfer on every cycle |
