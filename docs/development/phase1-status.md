...
| Windows clean build | PARTIAL | Windows CI definition and pinned commands are versioned; first CI run/clean native log is pending |
...
| Windows WinUSB and packaging | PARTIAL | WinUSB build path and HIL evidence contract are documented; native device evidence and packaging remain pending |
