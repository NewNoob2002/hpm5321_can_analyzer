...
| Physical cable hotplug | PASS | P3A/T-USB-007 completed 100/100 physical cable disappearance/re-enumeration cycles with readable/writable udev nodes and a successful exact 1 MiB recovery echo after every cycle; `docs/evidence/phase3/T-USB-007-current.json` |
