...
| Physical cable hotplug | NOT_TESTED | P3A/T-USB-007 owns physical cable cycling; automated reset/re-enumeration passed but does not substitute for it |
| Windows WinUSB and packaging | PARTIAL | Functional native/cross-built 64 MiB/reset/recovery HIL passed; P3A PnP record and P6 release EXE provenance/packaging remain pending |
