...
The probe deliberately never calls `board_init_can()` and never connects MCAN0
or MCAN2 to the physical TXD/RXD pads. This is a safety invariant: internal
loopback must remain isolated from a populated, hardware-enabled transceiver.
